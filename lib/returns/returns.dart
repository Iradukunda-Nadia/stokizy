                    ...
                    if (snapshot.hasData) {
                      ...
                      return ListView(
                          children: documents.map((doc) => doc['name'].toLowerCase().contains(searchController.text
                              .toLowerCase())
                              || doc['id'].contains(searchController.text.toLowerCase()) ?
                          ListTile(
                            onTap: () {
                              Navigator.of(context).push(CupertinoPageRoute(
                                  builder: (context) => Clearance(
                                    ...
                                    region: doc['region'],
                                    docID: doc.id,
                                    reason: doc.data().toString().contains('reason')? doc['reason'] :'',
                                    dateCleared: doc.data().toString().contains('dateCleared')? doc['dateCleared'] :'',
                                    pfn: doc['pfn'],
                                  )));
                            },
